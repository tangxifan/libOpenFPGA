...
void RRGraph::build_global_rr_graph(const t_build_rr_graph_opts build_opts,
                                    const t_arch& arch, 
  ...
  if (arch->num_directs > 0) {
    clb_to_clb_directs = alloc_and_load_clb_to_clb_directs(arch.Directs, 
                                                           arch.num_directs, 
